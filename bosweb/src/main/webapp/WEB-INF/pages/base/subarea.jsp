...
<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false"
    ...
    <div style="height:31px;overflow:hidden;" split="false" border="false">
        <div class="datagrid-toolbar">
            ...
            <script type="text/javascript">
                $('#save').click(function () {
                    var jQuery = $('#saveSubarea').form('validate');
                    if (jQuery) {
                        $('#saveSubarea').submit();
                    }
                });
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="saveSubarea" action="subareaAction_saveSubarea.action" method="post">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td>选择区域</td>
                    <td>
                        <input class="easyui-combobox" name="bcRegionByRegionId.id"
                               data-options="valueField:'id',textField:'name',url:'regionAction_listRegion'"/>
                    </td>
                </tr>
                <tr>
                    <td>关键字</td>
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="findSubarea">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td>省</td>
                    <td><input type="text" name="bcRegionByRegionId.province"/></td>
                </tr>
                <tr>
                    <td>市</td>
                    <td><input type="text" name="bcRegionByRegionId.city"/></td>
                </tr>
                <tr>
                    <td>区（县）</td>
                    <td><input type="text" name="bcRegionByRegionId.district"/></td>
                </tr>
                <tr>
                    <td>关键字</td>
                ...
                <script type="text/javascript">
                    $(function () {
                        $("#btn").click(function () {
                            var jQuery = $('#findSubarea').serializeJson();
                            $('#grid').datagrid("load", jQuery);
