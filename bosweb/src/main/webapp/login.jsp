		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					action="${pageContext.request.contextPath}/userAction_loginAction.action">
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a onclick="document.getElementById('loginform').submit()" href="#"
                           id="loginform:j_id19"
                    ...
                    <div align="center" ><font color="#00ff7f"><s:actionerror/></font></div>
